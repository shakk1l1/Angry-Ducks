...
class ObstacleSegment (var postionx:Double,var postiony:Double,val longueur:Double, val nx:Double,val ny:Double) {
    ...
    fun draw(canvas: Canvas){
        canvas.drawLine((postionx+ny*longueur/2).toFloat(),(postiony-nx*(longueur/2)).toFloat(),(postionx-ny*(longueur/2)).toFloat(),(postiony+nx*(longueur/2)).toFloat(), segmentPaint)
